...
import { LayoutDashboard, KanbanSquare, Users, Settings, UserCircle, LogOut } from "lucide-react";
...
export const Sidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-[280px] border-r border-sidebar-border bg-sidebar">
